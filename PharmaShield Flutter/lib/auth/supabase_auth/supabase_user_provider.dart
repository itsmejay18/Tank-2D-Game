...
class PharmaShieldSupabaseUser extends BaseAuthUser {
  PharmaShieldSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> pharmaShieldSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = PharmaShieldSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
